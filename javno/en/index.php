 ...
 <div class="kraj">
  ...
  <div class="table">
   ...
   <div class="tabla">
    ...
    <ul>
     <li>
      <a href="https://pro.vdinar.info" target="_blank">vDinar for developers</a>
     </li>
     <li>
      <a href="https://www.vdinar.info/viki" target="_blank">vDinar Wiki</a>
     </li>
     <li>
      <a href="https://vdinar.jugoslaven.com/en/wallet" target="_blank">Web wallet</a>
     </li>
    </ul>
   </div>
